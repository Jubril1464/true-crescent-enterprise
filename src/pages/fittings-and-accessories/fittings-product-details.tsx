...
import { fittingsProductServices } from "@src/utils/data";
...
const FittingsProductDetails = () => {
  ...
  useEffect(() => {
    setProductDetails(
      fittingsProductServices.find((product) => product.id == Number(id)) ||
        ({} as ProductDetails)
    );
  }, [id]);
  return (
...
export default FittingsProductDetails;
